...
int hislip0_message_sync(int socket, uint32_t message_id, void *buffer, int length, int timeout)
{
    ...
    return hs_server_send_response(socket, message_id, response_buffer, response_length, timeout);
}
